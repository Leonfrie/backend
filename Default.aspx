...
<body>
    <form id="form1" runat="server">
        <asp:RadioButtonList ID="showFormulier" runat="server" OnSelectedIndexChanged="showFormulier_SelectedIndexChanged" AutoPostBack="True">
            <asp:ListItem Value="1">Laat zien</asp:ListItem>
            <asp:ListItem Value="">Laat niet zien</asp:ListItem>
        </asp:RadioButtonList>
